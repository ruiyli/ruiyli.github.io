...
<div align="center">
  {% include figure.liquid path="assets/img/20260115/Imagen_gens.png" class="img-fluid rounded z-depth-1" width="400" alt="Imagen_gens" %}
  <p style="text-align: center; margin-top: 2px; font-size: 12px">Imagen_gens</p>
</div>
