...
{% include figure.liquid path="assets/img/20260115/Imagen_gens.png" class="img-fluid rounded z-depth-1" width="800" alt="Imagen_gens" caption="Some examples of text to image by Imagen %}
